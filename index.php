...
$title = 'Mugs Party';
$mugColors = ['Black', 'White', 'Purple', 'Brown', 'Pink', 'Green', 'Yellow'];
...
<body>
    ...
    <div id="sorting-bar" class="container-fluid sorting-bar">
        ...
        <nav class="navbar navbar-light bg-light justify-content-between">
            <div class="btn-group">
            <p class="pr-2">en stock:</p>
                <button type="button" class="btn btn-white border border-dark dropdown-toggle" data-toggle="dropdown" aria-haspopup="true"
                    aria-expanded="false">
                    Action
                </button>
            ...
            <form class="form-inline">
                <button class="btn btn-outline-success my-sm-0 bg-success mx-3 text-dark" type="submit">Trier</button>
                <button class="btn btn-outline-danger bg-danger text-dark my-sm-0" type="submit">Reset</button>
            </form>
        </nav>
    </div>
    ...
    <div class="container mt-40">
        ...
        <div class="row">
        <?php $sql = 'SELECT M.id, M.title, M.slug, M.image, M.description, M.qte, M.price M.color, M.size, M.new, M.tendance,  
                FROM mugs_party AS M
                INNER JOIN mugs AS M 
                ON M.image = M.id
                ORDER BY color DESC
                LIMIT 6';
                $mugs = query($sql);
                ...
                <?php foreach ($mugs as $mug): ?>
                <div class="col-lg-4 col-md-6 col-sm-12 py-3">
                    <div class="card" style="width: 18rem;">
                    <img class="image__img" src="<?= $mug['image']; ?>" alt="<?= $mug['title']; ?>">
                        <div class="card-body">
                        <?php
                            echo $mug['title'];
                            ?>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-sm-6 footer-box">
                    ...
                    <h4><?= $title; ?></h4>On y trouve de tout et surtout du n'importe quoi !!</p>
